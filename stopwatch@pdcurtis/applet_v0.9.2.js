...
help and a version/update files and also the gnome system monitor program in case you want to find out how much machine power this applet is using at various update rates. 
*/
    ...
    buildContextMenu: function () {
        ...
        menuitem.connect('activate', Lang.bind(this, function (event) {
            if(this.counterPaused) {
                  ...
                  this.counterRunning = true;
                  this.counterPaused = this.counterReady = false;
                  this.startTime = this.getCurrentTime() - this.currentCount;
                  this.updateUI();
            } 
        } ));
        this._applet_context_menu.addMenuItem(menuitem);
    ...
    updateUI: function() {
         ...
         if(this.counterPaused) {
             ...
             this.set_applet_tooltip(this.counterTitle + " paused at " + this.verboseCount + " - Click to Reset"); 
                ...
                if (this.days > 0 ) {this.actor.style = "background-color: rgba(127,0,0,1.0)";} // Dark Red
         if(this.counterReady) {
